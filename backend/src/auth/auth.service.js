...
var AuthService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        payload = { email: user.email, sub: user.id, username: user.username };
                        return [2 /*return*/, {
    ...
    AuthService.prototype.register = function (createUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            var existingUser, hashedPassword, user, savedUser, _, result, payload;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (existingUser) {
                            throw new common_1.UnauthorizedException('User already exists with this email or username');
                        }
                    ...
                    case 3:
                        savedUser = _a.sent();
                        _ = savedUser.password, result = __rest(savedUser, ["password"]);
                        payload = { email: result.email, sub: result.id, username: result.username };
                        return [2 /*return*/, {
                                access_token: this.jwtService.sign(payload),
                                user: {
                                    id: result.id,
    ...
    AuthService.prototype.profile = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var user, _, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
