...
var FeedsService = /** @class */ (function () {
    function FeedsService(feedRepository) {
        this.feedRepository = feedRepository;
    }
    FeedsService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.feedRepository.find({
                        where: { isActive: true },
                        relations: ['category'],
                        order: { name: 'ASC' }
                    })];
    ...
    FeedsService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.feedRepository.findOne({
